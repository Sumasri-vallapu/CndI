...
export default function ChildrenAttendance() {
  ...
  const actions = [
    { label: "Add Children Attendance", onClick: () => navigate("/add-children-attendance") },
    { label: "View Children Attendance", onClick: () => navigate("/view-children-attendance") },
  ];
    ...
    <div className="min-h-screen bg-[#F4F1E3] flex flex-col items-center px-4 py-6">
      ...
      <div className="flex flex-col items-center justify-center space-y-2">
                    <img
                        ...
                        loading="eager"
                    />
                    <h2 className="text-xl font-bold text-walnut">Children Attendance</h2>
                </div>
