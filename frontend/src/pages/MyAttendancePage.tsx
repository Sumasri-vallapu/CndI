...
export default function MyAttendancePage() {
  ...
  const actions = [
    { label: "Mark My Attendance", onClick: () => navigate("/fellow-attendance") },
    { label: "View Attendance History", onClick: () => navigate("/fellow-attendance-history") },
  ];
  ...
  return (
    <div className="min-h-screen bg-[#F4F1E3] flex flex-col items-center px-4 py-6">
      ...
      <div className="w-full max-w-3xl bg-white p-6 rounded-lg shadow-md space-y-6 mt-8">
        <h2 className="text-2xl font-bold text-center text-walnut mb-6">My Attendance</h2>
