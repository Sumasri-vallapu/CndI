...
const Testimonials = () => {
  ...
  return (
    <div className="relative w-full max-w-4xl mx-auto p-6 bg-white shadow-lg rounded-lg">
      <h3 className="text-2xl font-bold text-walnut text-center mb-4">What Our Fellows Say</h3>
      <div className="overflow-hidden w-full transition-opacity duration-700 ease-in-out">
