...
export default function AboutUs() {
  ...
  return (
    <div className="min-h-screen bg-[#27465C] flex flex-col">
      ...
      <nav className={`w-full py-3 px-4 md:px-8 transition-all duration-700 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 -translate-y-4'}`}>
        <div className="max-w-7xl mx-auto flex justify-between items-center">
          ...
          <div className="flex items-center gap-6">
            <button onClick={() => navigate('/')} className="text-white hover:opacity-80 text-sm">Home</button>
            <button onClick={() => navigate('/about')} className="text-white hover:opacity-80 text-sm border-b-2 border-white">About Us</button>
      ...
      {/* Hero Section */}
      <section className={`py-6 px-6 text-center transition-all duration-700 delay-300 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
        <h1 className="text-2xl md:text-3xl font-black text-white mb-4">
          About Connect & Inspire
        </h1>
        <p className="text-base text-white opacity-90 max-w-3xl mx-auto">
      ...
      {/* Mission Section */}
      <section className={`py-4 px-6 transition-all duration-700 delay-500 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
        <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-6 items-center">
          ...
          <div className="bg-white bg-opacity-10 rounded-xl p-4 text-center shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2">
            <div className="w-8 h-8 mx-auto mb-2 flex items-center justify-center">
              <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z" />
              </svg>
            </div>
            <h3 className="text-base font-bold text-white">Our Goal</h3>
            <p className="text-white opacity-80 mt-1 text-xs">Making expert knowledge accessible worldwide</p>
          </div>
        </div>
      </section>

      {/* Problem We Solve */}
      <section className={`py-4 px-6 transition-all duration-700 delay-700 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
        <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-6 items-center">
          <div className="bg-white bg-opacity-10 rounded-xl p-4 text-center shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2">
            <div className="w-8 h-8 mx-auto mb-2 flex items-center justify-center">
              <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <p className="text-white opacity-80 mt-1 text-xs">Finding the right speaker shouldn't be difficult</p>
          </div>
          <div>
            <h2 className="text-xl font-black text-white mb-3">The Problem We Solve</h2>
            <p className="text-white opacity-90 text-base leading-relaxed">
      ...
      {/* Unique Value */}
      <section className={`py-4 px-6 transition-all duration-700 delay-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
        ...
        <div className="grid md:grid-cols-3 gap-4 max-w-6xl mx-auto">
          {[
            ...
            <div key={i} className="bg-white bg-opacity-10 rounded-xl p-3 text-center backdrop-blur-sm shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2">
              <div className="w-8 h-8 mx-auto mb-2 flex items-center justify-center">
                {i === 0 && (
                  <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <p className="text-white opacity-80 text-xs">{item.desc}</p>
            </div>
          ))}
        </div>
      </section>
      ...
      {/* Team Section */}
      <section className={`py-4 px-6 transition-all duration-700 delay-[1200ms] ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
        <h2 className="text-xl font-black text-center text-white mb-6">
          Meet Our Team
        </h2>
        <div className="grid md:grid-cols-4 gap-4 max-w-6xl mx-auto">
          {[
            ...
            <div key={i} className="bg-white bg-opacity-10 rounded-xl p-4 text-center backdrop-blur-sm shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2">
              ...
              <p className="text-white opacity-80 text-xs">{member.role}</p>
            </div>
          ))}
        </div>
      </section>
      ...
      {/* CTA Section */}
      <section className={`py-6 px-6 text-center transition-all duration-700 delay-[1400ms] ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
        <h2 className="text-xl font-black text-white mb-3">
          Ready to Get Started?
        </h2>
        <p className="text-white opacity-90 mb-4 max-w-2xl mx-auto text-sm">
        ...
        <div className="flex flex-col sm:flex-row gap-3 justify-center">
          <button
            ...
            className="bg-white text-black px-6 py-2.5 rounded-lg text-base font-medium hover:bg-gray-100 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-1"
          >
            Find Speakers
          </button>
          <button
